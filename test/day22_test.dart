...
on x=10..10,y=10..10,z=10..10''';
  ...
  test('Cube intersections', () {
    String testInput = '''on x=10..20,y=10..20,z=10..20
on x=15..25,y=15..25,z=15..25
on x=5..25,y=15..25,z=15..25
on x=5..25,y=12..18,z=12..18''';
    CubeSpace cubes = CubeSpace();
    for (String line in testInput.split('\n')) {
      Command command = Command.fromInputLine(line);
      Cube cube = Cube.fromCommand(command);
    ...
    //expect(cubes.cubeList.length, 2);
    cubes.cubeList.first.getIntersection(cubes.cubeList[3]).print();

  });

  test('Test part 1 example 1', () {
    String testInput = '''on x=10..12,y=10..12,z=10..12
on x=11..13,y=11..13,z=11..13
off x=9..11,y=9..11,z=9..11
on x=10..10,y=10..10,z=10..10''';
    ...
    for (String line in testInput.split('\n')) {
      ...
      debugPrint('$line : ${cubes.getVolume()}');
    }
    expect(cubes.getVolume(), 39);
  });

  test('Test part 1 example 2', () {
